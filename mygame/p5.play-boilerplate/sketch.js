...
function draw() {
  ...
  if(gameState == "play"){
    ...
    if(level == 2){
      ...
      platform2.reset(2200,500,1);
     
      platform3.reset(2500,400,3);

      platform4.reset(3200,500,12);

      platform5.reset(3900,300,4);

      platform6.reset(4600,500,1);
  ...
  //  console.log(camera.position.x);
    ...
    for(var element in platforms){
      platforms[element].plat.debug = true;
